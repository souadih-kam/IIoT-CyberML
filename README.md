...
3. Launch the notebook:
   ```bash
   jupyter notebook notebooks/IIoT_IDS_Analysis.ipynb
   ```
...
```bibtex
@article{YourName2025IIoT,
  title={Unified Intrusion Detection for Industrial IoT},
  author={Surname, Name and Author, Another},
